      ...
      >
        {fields.map((field, index) => (
          <fieldset key={field.id} className="flex flex-col items-center">
            ...
            <div className="font-alumnibold form-control max-w-xs text-center">
            ...
            <div className="mt-4 w-full flex flex-col items-center">
              ...
              <input
                ...
                type="text"
                placeholder="Email"
                className={`input input-bordered w-full max-w-xs mt-4 mb-4 ${
            ...
            {guestsValues?.[index]?.attendingWedding === "true" && (
              <>
                <fieldset className=" flex flex-col items-center">
                  <div className="font-alumnibold form-control max-w-xs">
            ...
            <button
              ...
              className="btn text-xl font-light w-full bg-blue hover:bg-darkblue text-white w-1/2 mt-4"
        ...
        <div className="flex flex-col">
          <button
            ...
            className="btn self-center w-1/2 w-full text-xl hover:bg-darkblue font-light bg-blue text-white mt-4"
